...
class ProductTile extends StatelessWidget {
  ...
  const ProductTile({super.key, required this.produtDataModel, required this.homeBloc});
  @override
            ...
            children: [
              ...
              Row(
                children: [
                  IconButton(
                    onPressed: () {
                      homeBloc.add(HomeProductWishlistButtonCLickedEvent( clickedProduct: produtDataModel));
                    },
                    icon: Icon(
                  ...
                  IconButton(
                    onPressed: () {
                      homeBloc.add(HomeProductCartButtonCLickedEvent(clickedProduct: produtDataModel));
                    },
                    icon: Icon(
